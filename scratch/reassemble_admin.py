...
files = [f for f in os.listdir(scratch_dir) if f.startswith("extracted_admin_jsonl_")]

print(f"Lendo {len(files)} candidatos de admin em {scratch_dir}...")
...
for file in files:
    ...
    try:
        ...
        # Encontra blocos de linhas do tipo "50:  def list_..." ou "50: def list_..."
...
if assembled_lines:
    ...
    # Vamos escrever o arquivo ordenado
    out_path = r"c:\Users\pc\source\sgeplus\scratch\reassembled_admin.py"
